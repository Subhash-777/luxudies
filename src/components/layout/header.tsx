    ...
    <>
      ...
      <header
        className={cn(
          ...
          isScrolled
            ? 'bg-pearl/85 backdrop-blur-xl shadow-soft border-b border-gold-400/10'
            : 'bg-pearl/60 backdrop-blur-md'
        )}
      >
          ...
          <div className="flex items-center justify-between h-16 lg:h-[72px]">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="lg:hidden p-2 -ml-2 text-espresso hover:text-gold-500 transition-colors"
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="px-3 py-2 text-[11px] font-inter font-medium tracking-[0.08em] text-espresso-300 hover:text-gold-500 transition-colors relative group"
                >
                  {link.label}
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <Link
                href="/shop"
                className="p-2 text-espresso-300 hover:text-gold-500 transition-colors hidden sm:flex"
                aria-label="Search"
              >
              ...
              <Link
                ...
                className="p-2 text-espresso-300 hover:text-gold-500 transition-colors relative"
                aria-label="Wishlist"
              >
              ...
              >
                ...
                {cartItemCount > 0 && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute top-0.5 right-0.5 w-4 h-4 bg-gold-400 text-white text-[10px] font-bold rounded-full flex items-center justify-center"
                  >
                    {cartItemCount}
                  </motion.span>
                )}
